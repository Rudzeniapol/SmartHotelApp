...
async def create_tables():
    commands = (
        ...
        (
            ...
            check_in    DATE    NOT NULL,                                               -- The first day of the booking
            check_out   DATE    NOT NULL,                                               -- The day *after* the last night of stay (i.e., checkout date, booking is up to, but not including, this date)
